...
export function calculateRating(rating) {
	...
	let sum = rating.reduce(function (a, b) {
		console.log("ratingItem[b[1]].name ", ratingItem[b[0]]?.name)
		//console.log("ratingItem[b[0]].rate ", ratingItem[b[0]]?.rate)
		console.log("b[1] * ratingItem[b[0]].rate ", b[1] * ratingItem[b[0]].rate)
