...
import { getAllPostsForHome, getAllStoriesForHome, getAllPostsForTop } from "../lib/api";
		...
		<>
			<Layout preview={preview} color={true} bgColor={false}>
				...
				<Container>
					...
					<div className="bg-white my-20 dark:bg-gray-800 overflow-hidden relative">
					<div className="text-start w-1/2 py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
						<h2 className="text-3xl font-extrabold text-black dark:text-white sm:text-4xl">
							<span className="block">
								Check out our top <span className=" text-pink-500">
						...
						<div className="lg:mt-0 lg:flex-shrink-0">
							...
							<Link href='/top_picks' passHref>
								<button type="button" className="py-4 px-6  bg-pink-500 hover:bg-pink-600 focus:ring-pink-500 focus:ring-offset-pink-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
									Top Picks
								</button>
								</Link>
							</div>
					...
					<div className="absolute h-full max-w-1/2  lg:block right-0 top-0"> 
					<Image
					src='/allposts.webp'
					width={496}
					height={355}
				...
				/></div>
					...
					{ moreStories.length > 0 && <div className=' bg-yellow-50 rounded-3xl py-8 my-10 relative '>
