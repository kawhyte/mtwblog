		...
		<section className='text-gray-600 body-font'>
					...
					<div className='p-4 lg:w-1/2 md:w-full'>
						<div className='flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col'>
							...
							<div className='flex-grow'>
								...
								<div classNameName='flex flex-col sm:items-start sm:text-left  items-center -mb-1 space-y-2.5'>
									<ul>
										{positives?.map((positive, index) => (
											<li key={index} classNameName="my-3 leading-relaxed">
			...
			<div className='flex border-2 my-12 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col'>
				...
				<div className='flex-grow'>
					...
					<div classNameName='flex flex-col sm:items-start sm:text-left leading-relaxed  items-center -mb-1 space-y-2.5'>
						<p classNameName="font-sans">
						{verdict}
						</p>
					</div>
				</div>
